...
namespace MissionPlanner.GCSViews
{
    ...
    public void ConnectComPort_Click(object sender, EventArgs e)
        {
            if (threadrun == 0)
            {
                OutputLog.Clear();
        ...
        public void but_advsettings_Click(object sender, EventArgs e)
        {
        ...
        public void BUT_startfgquad_Click(object sender, EventArgs e)
        {
            string extra = "";
        ...
        public void BUT_startfgplane_Click(object sender, EventArgs e)
        {
            string extra = "";
            OpenFileDialog ofd = new OpenFileDialog()
            {
        ...
        public void BUT_startxplane_Click(object sender, EventArgs e)
        {
            OpenFileDialog ofd = new OpenFileDialog()
            {
