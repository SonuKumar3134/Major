...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public class menuicons
        {
            ...
            public Image speech = global::MissionPlanner.Properties.Resources.ere;
        ...
        public class menuicons2 : menuicons
        {
            ...
            public new Image speech = global::MissionPlanner.Properties.Resources.ere;
        ...
        //  public GCSViews.Speech1 Speech1;
        ...
        public MainV2()
        {
            ...
            //Subscribing Function named FunctionCaller to XMLCreated Event.
            //Whenever an XMLCreated Event is raised all the functions subscribed to XMLCreated will be executed.
            //In this application FunctionCaller is the only function subscribed to XMLCreated Event,
            //So this function will get execued as soon as the Event is raised.
            SpeechInterfaceButtonDLL.PythonNLP.XMLCreated += FunctionCaller;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            MyView.AddScreen(new MainSwitcher.Screen("HWConfig", new GCSViews.InitialSetup(), true));
            MyView.AddScreen(new MainSwitcher.Screen("SWConfig", new GCSViews.SoftwareConfig(), true));
            MyView.AddScreen(new MainSwitcher.Screen("Simulation", Simulation, true));
            MyView.AddScreen(new MainSwitcher.Screen("Terminal", new GCSViews.Terminal(), true));
            MyView.AddScreen(new MainSwitcher.Screen("Help", new GCSViews.Help(), true));
            MyView.AddScreen(new MainSwitcher.Screen("Speech1", new GCSViews.Speech1(), false));
